# Generated by Django 4.2 on 2026-03-04 05:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecture_file', models.FileField(blank=True, null=True, upload_to='lectures/', verbose_name='Maruza fayli (PDF/Word)')),
                ('order', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='Tavsif')),
                ('icon', models.CharField(blank=True, max_length=100, verbose_name='Icon (Bootstrap)')),
        ...
        migrations.AddField(
            model_name='course',
            name='subject',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='courses', to='courses.subject', verbose_name='Fan'),
        ),
        migrations.CreateModel(
            name='LessonProgress',
            fields=[
